...
describe "About integration" do
  it "shows testimonials and achievements" do
    ...
    testimonial_1 = create(:testimonial, rank: 1, provider_name: 'Richie Benaud', recommendation: "Top bloke!")
    testimonial_2 = create(:testimonial, rank: 2, provider_name: 'Ian Chappell', recommendation: "Bloody good bloke!")
    visit about_path
